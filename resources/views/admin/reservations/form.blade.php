                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="{{ route('admin.reservations.update', $reservation->id) }}" method="POST">
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-12">
                                    <label for="slots"
                                        class="form-label fw-bold text-muted small text-uppercase">Rezervované hodiny
                                        (oddělené čárkou)</label>
                                    <input type="text" class="form-control bg-light border-0 py-2 font-monospace"
                                        id="slots" name="slots"
                                        value="{{ old('slots', is_array($reservation->slots) ? implode(', ', $reservation->slots) : implode(', ', json_decode($reservation->slots, true) ?? [])) }}"
                                        required>
                                    <div class="form-text small">Zapisujte přesně ve formátu: <code>09:30 - 10:30, 10:30 -
                                            11:30</code></div>
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-6">
                                    <label for="parent_name"
                                        class="form-label fw-bold text-muted small text-uppercase">Jméno rodiče</label>
                                ...
                                <div class="col-md-6">
                                    <label for="contact" class="form-label fw-bold text-muted small text-uppercase">Kontakt
                            ...
                            <div class="mb-4">
                                <label for="note" class="form-label fw-bold text-muted small text-uppercase">Poznámka
                                    rodiče</label>
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select bg-light border-0 py-2" id="pricing_model"
                                        ...
                                        <option value="Parťák na hodinu"
                                            {{ $reservation->pricing_model === 'Parťák na hodinu' ? 'selected' : '' }}>
                                            Parťák na hodinu</option>
                                        <option value="Celodenní parťák"
                                            {{ $reservation->pricing_model === 'Celodenní parťák' ? 'selected' : '' }}>
                                            Celodenní parťák</option>
                                    </select>
                                </div>
                            </div>
